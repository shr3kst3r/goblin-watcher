...
- Like `--research`, it always starts a fresh session and is a property of that session, not the task. Multi-repo tasks get one block per repo. See [ADR 0007](docs/adrs/0007-address-review-seed-prompt.md).
